...
self.startlevelupPokemon = self.playerPokemon
print('--------------------------------------------------------')
print('Pokemon antes de levelup')
print_r(self.playerPokemon)
print('--------------------------------------------------------')
print('--------------------------------------------------------')
print('Pokemon variable')
print_r(self.startlevelupPokemon)
		starthp = self.startlevelupPokemon.HP
		startspeed = self.startlevelupPokemon.speed
		startattack = self.startlevelupPokemon.attack
		startdefense = self.startlevelupPokemon.defense
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        stats = self.playerPokemon:levelUp()
						--self.levelupPanel = Panel(0, VIRTUAL_HEIGHT - 64, VIRTUAL_WIDTH, 64)
						--print_r(stats)
LevelupPokemon = self.playerPokemon
print('--------------------------------------------------------')
print('Pokemon DEPOIS de levelup')
print_r(self.playerPokemon)
print('--------------------------------------------------------')
						
						-- gStateStack:push(BattleMessageState('Current EXP ' .. tostring(self.playerPokemon.currentExp) .. ' No Level up',
							--function() end, false))

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()
						print('Logo antes de chamar menu')
						--print_r(self.startlevelupPokemon)
						print(starthp, startspeed, startattack, startdefense)
							gStateStack:push(LevelupMenuState(self.playerPokemon, starthp, startspeed, startattack, startdefense, self.battleState))
