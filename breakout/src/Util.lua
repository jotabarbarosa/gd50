...
function GenerateQuadsBricks(atlas)
	brickTable = {}	
	--32x16 tamanho do brick do indice 1 até o 21 (são 21 bricks)
...
function GenerateQuadsPowerup(atlas)
	...
	local counter = 1
    local quads = {}
	--quads[1] = love.graphics.newQuad(96, 196, 16, 16, atlas:getDimensions())
	--quads[1] = love.graphics.newQuad(144, 196, 16, 16, atlas:getDimensions())
