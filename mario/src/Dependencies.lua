...
gTextures = {
	...
	['bushes-garden'] = love.graphics.newImage('graphics/bushes_and_cacti.png'),
    ...
    ['keysl'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
	...
	['bushes-garden'] = GenerateQuads(gTextures['bushes-garden'], 112, 16),
